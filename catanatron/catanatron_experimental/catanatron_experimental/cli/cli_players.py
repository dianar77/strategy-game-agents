...
from agents.fromScratchLLMStructured_player_v9.foo_player import FooPlayer as FooLLMStructuredPlayerV9
...
CLI_PLAYERS = [
    ...
    # ),
     ...
     CliPlayer(
         "FOO_LLM_S9",
         "FooPlayer_LLM_S9",
         "Multi-agent evolved player (V9) with advanced strategic capabilities",
         FooLLMStructuredPlayerV9
     ),
]
