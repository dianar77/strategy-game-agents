...
def play_batch(
    ...
    # ===== CUSTOM OUTPUT For FOO Player
    # Print FooPlayer VP statistics in an easily extractable format
    # console.print("Custom Output for Foo Player:\n")
    # for player in players:
    #     console.print(f"Player: {str(player)}")
    #     if "FooPlayer" in str(player):
    #         vps = statistics_accumulator.results_by_player[player.color]
    #         avg_vps = sum(vps) / len(vps)
